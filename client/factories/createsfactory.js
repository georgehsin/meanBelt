console.log('Creates Factory');
myApp.factory('createsFactory', ['$http', function($http) {
  // constructor for our factor
  

  function CreatesFactory(){
    var _this = this;
 ...
 //But only if you only want to run the callback from the controller.
  ...
  console.log(new CreatesFactory());
  return new CreatesFactory();
}]);